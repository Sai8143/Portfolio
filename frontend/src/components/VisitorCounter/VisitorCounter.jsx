      ...
      <Container>
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto leading-8 text-sm md:text-base">
            Real-time visitor telemetry, device analytics, and portfolio engagement metrics powered by a live FastAPI database engine.
          </p>
        </div>
            ...
            <div className="grid lg:grid-cols-[1fr_1.2fr] gap-12 items-center relative z-10">
              ...
              <div className="flex justify-center">
                <div className="relative w-[280px] h-[280px] flex items-center justify-center">
                  ...
                  <div className="relative text-center z-10">
                    ...
                    {!loading && count === null && (
                      <p className="mt-1 text-[10px] font-mono text-zinc-500 uppercase tracking-wider">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-slate-400 leading-8 mb-8 text-sm md:text-base">
                  Track unique portfolio visitors, browser environments, operating systems, and visitor activity synchronized with the backend database.
                </p>
                ...
                <div className="flex flex-wrap items-center gap-4 justify-center lg:justify-start">
                  ...
                  <div className="flex items-center gap-2 px-4 py-3 rounded-2xl border border-white/10 bg-white/[0.03] text-xs font-mono text-zinc-400">
                    ...
                    <span>{isOnline ? "Database Synced" : "Database Unavailable"}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 pt-8 border-t border-white/10 grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs font-mono text-slate-300 mt-0.5">
                    {isOnline ? "Tracking Active (100% Online)" : "Telemetry Degraded"}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs font-mono text-slate-300 mt-0.5">Unique Browser Tracking</p>
                </div>
              </div>
